...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/pause-work.md
</execution_context>
...
<process>
**Follow the pause-work workflow** from `@E:/git/smf-queue-check/.codex/get-shit-done/workflows/pause-work.md`.
