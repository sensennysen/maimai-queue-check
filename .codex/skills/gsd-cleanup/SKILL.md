...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/cleanup.md
</execution_context>

<process>
Follow the cleanup workflow at @E:/git/smf-queue-check/.codex/get-shit-done/workflows/cleanup.md.
