...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@E:/git/smf-queue-check/.codex/get-shit-done/workflows/check-todos.md`.
