...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/update.md
</execution_context>

<process>
**Follow the update workflow** from `@E:/git/smf-queue-check/.codex/get-shit-done/workflows/update.md`.
