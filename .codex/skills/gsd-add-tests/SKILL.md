...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @E:/git/smf-queue-check/.codex/get-shit-done/workflows/add-tests.md end-to-end.
