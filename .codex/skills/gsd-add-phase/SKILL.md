...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@E:/git/smf-queue-check/.codex/get-shit-done/workflows/add-phase.md`.
