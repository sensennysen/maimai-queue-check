...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@E:/git/smf-queue-check/.codex/get-shit-done/workflows/add-todo.md`.
