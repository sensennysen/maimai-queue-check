...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/settings.md
</execution_context>

<process>
**Follow the settings workflow** from `@E:/git/smf-queue-check/.codex/get-shit-done/workflows/settings.md`.
