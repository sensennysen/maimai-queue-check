...
<execution_context>
@E:/git/smf-queue-check/.codex/get-shit-done/workflows/resume-project.md
</execution_context>

<process>
**Follow the resume-project workflow** from `@E:/git/smf-queue-check/.codex/get-shit-done/workflows/resume-project.md`.
