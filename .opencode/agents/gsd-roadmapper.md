...
Reference full template: `E:/git/smf-queue-check/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/git/smf-queue-check/.opencode/get-shit-done/templates/state.md`.
