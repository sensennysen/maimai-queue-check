...
Use template from `E:/git/smf-queue-check/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/git/smf-queue-check/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/git/smf-queue-check/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
