...
Reference full template: `E:/git/smf-queue-check/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/git/smf-queue-check/.gemini/get-shit-done/templates/state.md`.
