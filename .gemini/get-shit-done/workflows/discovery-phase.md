...
See E:/git/smf-queue-check/.gemini/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/git/smf-queue-check/.gemini/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/git/smf-queue-check/.gemini/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/git/smf-queue-check/.gemini/get-shit-done/templates/discovery.md
...
Use E:/git/smf-queue-check/.gemini/get-shit-done/templates/discovery.md.
