...
```bash
INIT=$(node "E:/git/smf-queue-check/.gemini/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "E:/git/smf-queue-check/.gemini/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "E:/git/smf-queue-check/.gemini/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "E:/git/smf-queue-check/.gemini/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
