...
<!-- For checkpoint task examples and patterns, see @E:/git/smf-queue-check/.gemini/get-shit-done/references/checkpoints.md -->
...
See `E:/git/smf-queue-check/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/git/smf-queue-check/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/git/smf-queue-check/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
